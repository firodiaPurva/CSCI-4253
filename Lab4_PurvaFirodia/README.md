...
1) Commit and push your code to github.  Remember, don't add the data files to your repo.

2) Submit on Canvas, entering the URL of your repo.

3) Sign up for and show up for a grading interview slot.
